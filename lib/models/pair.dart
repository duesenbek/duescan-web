...
class Pair extends Equatable {
  ...
  factory Pair.fromDex(Map<String, dynamic> j, {required String chainId}) {
    try {
      ...
      String? imageUrl = j['info']?['imageUrl'] as String?;
      
      // If no image in info, try baseToken
      imageUrl ??= baseToken?['imageUrl'] as String?;
      
      // If still no image, try other common fields
      imageUrl ??= j['imageUrl'] as String?;
      imageUrl ??= j['icon'] as String?;
