          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: pair.baseToken.imageUrl != null && pair.baseToken.imageUrl!.isNotEmpty
                    ? ClipRRect(
                        borderRadius: BorderRadius.circular(16),
                        child: Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            ...
                            print('Image URL: ${pair.baseToken.imageUrl}');
                            print('Base Image URL: ${pair.baseImageUrl}');
                            ...
                            return Container(
                              ...
                              child: Center(
                                child: Text(
                                  pair.baseToken.symbol.isNotEmpty ? pair.baseToken.symbol[0].toUpperCase() : '?',
                                  style: TextStyle(
